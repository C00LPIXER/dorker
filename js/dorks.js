export const dorks = [
  ...
  },
  {
    ...
    description:
      "Searches for exposed server backup files that might contain sensitive information or configurations.",
    dork: "site:{domain} filetype:bak OR filetype:backup OR filetype:old",
  },
  {
    title: "Exposed Source Code Repositories",
    description:
      "Identifies publicly exposed Git repositories that may contain sensitive or proprietary source code.",
    dork: 'site:{domain} intitle:"index of /.git" OR inurl:.git "config" OR "HEAD"',
  },
  {
    title: "Exposed Backup WordPress Files",
    description:
      "Searches for exposed backup files from WordPress sites, potentially containing databases or configurations.",
    dork: 'site:{domain} filetype:sql OR filetype:tar "wp-config" OR "wordpress"',
  },
  {
    title: "Exposed .env Files",
    description:
      "Locates exposed `.env` files that may contain sensitive environment variables such as API keys and database credentials.",
    dork: 'site:{domain} filetype:env "API_KEY" OR "DATABASE_URL" OR "SECRET_KEY"',
  },
  {
    title: "Exposed Firebase Database Files",
    description:
      "Locates exposed Firebase database files that might contain sensitive application data.",
